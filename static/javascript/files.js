...
function sortFiles(sortBy) {
  ...
  rows.sort((a, b) => {
    ...
    switch (sortBy) {
      ...
      case "size":
        valueA = parseFloat(a.children[1].textContent); // File size column
        valueB = parseFloat(b.children[1].textContent);
      ...
      case "last_modified":
        valueA = new Date(a.children[3].textContent); // Last modified column
