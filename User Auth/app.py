...
csp = {
    ...
    'script-src': ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com", "https://demo.arcade.software", "https://www.googletagmanager.com", "https://offfurreton.com"],  # Allow inline scripts
    ...
    'connect-src': ["'self'", "https://api.backblazeb2.com", "*.backblazeb2.com", "https://www.googletagmanager.com", "https://www.google-analytics.com", "https://tupnobmhar.xyz"],  # Allow API calls (uploads)
